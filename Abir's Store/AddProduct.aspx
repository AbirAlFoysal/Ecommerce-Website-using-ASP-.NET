    ...
    <div class ="container">
       <div class ="form-horizontal">
           ...
           <div class ="form-group">
            ...
            <div class ="form-group">
               <asp:Label ID="Label8" runat="server" CssClass ="col-md-2 control-label" Text="Features"></asp:Label>
               <div class ="col-md-3">
            ...
            <div class ="form-group">
               <asp:Label ID="Label10" runat="server" CssClass ="col-md-2 control-label" Text="Comments"></asp:Label>
               <div class ="col-md-3">
           ...
           <div class ="form-group">
            ...
            <div class ="form-group">
               <asp:Label ID="Label18" runat="server" CssClass ="col-md-2 control-label" Text="Apply Discount"></asp:Label>
               <div class ="col-md-3">
                   <asp:CheckBox ID="cbCOD" runat="server" />
               </div>
           </div>
                          <div class ="form-group">
               <asp:Label ID="Label19" runat="server" CssClass ="col-md-2 control-label" Text="Delivary Option"></asp:Label>
               <div class ="col-md-3">
