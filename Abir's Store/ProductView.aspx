    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-md-5">
            ...
            <div class="divDet1">
                ...
                <span class="proOgPriceView">Tk.<%#Eval("PPrice","{0:c}") %></span> <span class="proPriceDiscountView"> Off Tk.<%# string.Format("{0}",Convert.ToInt64(Eval("PPrice"))-Convert.ToInt64(Eval("PSelPrice"))) %></span><p class="proPriceView">Rs. <%#Eval("PSelPrice","{0:c}") %></p>
            </div>
            <div >
                <h5 class="h5size"> </h5>
                <div>
                    <asp:radiobuttonlist ID="rblSize" runat="server" RepeatDirection="Horizontal" >
                        <asp:ListItem Value="S" Text="Black"></asp:ListItem>
                        <asp:ListItem Value="M" Text="White"></asp:ListItem>
                        <asp:ListItem Value="L" Text="Grey"></asp:ListItem>
                        <asp:ListItem Value="XL" Text="Purple"></asp:ListItem>
                    </asp:radiobuttonlist>
                </div>
            </div>
            <div class="divDet1">
                <asp:button ID="btnAddtoCart" Class="btn btn-success" runat="server" text="ADD TO CART" OnClick="btnAddtoCart_Click"/>
           <asp:Label ID="lblError" CssClass ="text-danger " runat="server" ></asp:Label>
            ...
            <div class="divDet1">
                ...
                <p>   <%#Eval("PDescription") %>          </p>
                 ...
                 <h5 class="h5size">Features</h5>
                <p>   <%#Eval("PProductDetails") %>     </p>
                 <h5 class="h5size"> Comments</h5>
