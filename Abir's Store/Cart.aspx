            ...
            <ContentTemplate>
                ...
                <br />
                    <button id="btnCart2" runat="server" class="btn btn-primary navbar-btn pull-right" onserverclick="btnCart2_ServerClick" type="button">
                        View My Cart <span id="CartBadge" runat="server" class="badge">0</span>
                    </button>
                    <div style="padding-top: 50px">
                                ...
                                <ItemTemplate>
                                    ...
                                    <div class="media" style="border: 1px solid black;">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span class="ProPriceViewCart">Tk.&nbsp <%# Eval("PSelPrice","{0:0.00}") %></span>
                                            <span class="proOgPriceView">Tk.&nbsp <%# Eval("PPrice","{0:0.00}") %></span>

                                            <span class="proPriceDiscountView"> Discount <%# string.Format("{0}",Convert.ToInt64(Eval("PPrice"))-Convert.ToInt64(Eval("PSelPrice"))) %> Tk.</span>
                                    ...
                                    <asp:TextBox ID="txtQty" runat="server" Width="40" Font-Size="Large" TextMode="SingleLine" Style="text-align: center" Text='<%# Eval("Qty") %>'></asp:TextBox>&nbsp
                                     <asp:Button ID="BtnPlus" CommandArgument='<%# Eval("PID") %>' CommandName="DoPlus" runat="server" Text="+" Font-Size="Large" />&nbsp&nbsp&nbsp                                          
                                            ...
                                            <br />
                                            <p>
                                                <asp:Button CommandArgument='<%#Eval("CartID") %>' CommandName="RemoveThisCart" ID="btnRemoveCart" Class="btn btn-danger" runat="server" Text="Remove" />
                                                <br />
                                                <span class="proNameViewCart pull-right">Total Amount: &nbsp <%# Eval("SubSAmount","{0:0.00}") %> Tk.</span>
                                            </p>
                                        </div>
                                    </div>
                                </ItemTemplate>
                        ...
                        <div class="col-md-3" runat="server" id="divAmountSect">
                            <div>
                                <h5 class=" proNameViewCart">Amounts</h5>
                            ...
                            <div>
                                <div class="cartTotal">
                                    ...
                                    <div>
                                        <asp:Button ID="btnBuyNow" Class="btn btn-success" runat="server" OnClick="btnBuyNow_Click" Text="BUY NOW" />
                                    </div>
                                </div>
                            </div>
                        </div>
